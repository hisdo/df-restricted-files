// 2016-12-10
// See also https://github.com/gdpelican/babble/blob/b2a319/assets/javascripts/discourse/babble-route-map.js.es6
export default {resource: 'admin', map() {
	...
	// «resetNamespace: true» is required here, otherwise we will get a failure:
	// «There is no route named adminFiles».
	this.route('adminFiles', {path: '/files', resetNamespace: true}, function() {
		Discourse.reopen({
			LOG_TRANSITIONS: true, LOG_TRANSITIONS_INTERNAL: true, LOG_VIEW_LOOKUPS: true
		});
